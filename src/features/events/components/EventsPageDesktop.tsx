    ...
    if (selectedEvent) {
        ...
        return (
                <div ref={pageRef} className="page-container events-page sm:pt-[56px]" style={{ background: 'var(--color-bg-primary)', scrollBehavior: 'smooth', paddingTop: 0 }}>
                    {/* Back Arrow Button - Desktop View Only */}
                    <div className="hidden md:block absolute top-4 left-4 md:top-6 md:left-6 z-50">
                        <Link
                            to="/events"
                            className="flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 hover:bg-white/20 backdrop-blur-sm transition-all duration-300 hover:scale-110"
                            style={{ color: '#EAEAEA' }}
                    ...
                    <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 md:px-12 pt-0 pb-6 sm:pb-8 md:pb-10 overflow-hidden">
                        {/* Background Gradient - Extended to top */}
                        <div
                            className="absolute inset-0 opacity-12 md:opacity-10 transition-opacity duration-300"
                            style={{ 
