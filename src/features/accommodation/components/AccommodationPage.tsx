        ...
        <div ref={pageRef} className="page-container" style={{ paddingTop: 0 }}>
            <section className="section" style={{ paddingTop: 0 }}>
                ...
                <div
                    ...
                    style={{
                        background: 'linear-gradient(135deg, rgba(139, 123, 181, 0.35), rgba(169, 155, 212, 0.25), rgba(10, 10, 20, 0.98))',
                        border: '1px solid rgba(139, 123, 181, 0.7)',
                        boxShadow: '0 18px 45px rgba(0, 0, 0, 0.55), 0 0 30px rgba(139, 123, 181, 0.2)',
                        opacity: 1,
                    }}
                >
