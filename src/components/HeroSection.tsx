...
const HeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[75%] mx-auto px-2 py-20 sm:py-24 lg:py-28 relative z-10 w-full">
            ...
            >
              <div className="flex flex-col mb-1 capitalize">
                ...
                <motion.h2
                  whileHover={{
                    scale: 1.01,
                    textShadow: "0 0 15px rgba(169, 155, 212, 0.25)"
                  }}
                  className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl font-bold whitespace-nowrap flex items-center cursor-pointer transition-colors duration-300"
                  style={{
                    fontFamily: '"Playfair Display", "Cormorant Garamond", serif',
                    fontStyle: 'normal',
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <AnimatePresence mode="wait">
                ...
                >
                  <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold leading-[1.05] tracking-tight italic whitespace-nowrap"
                    style={{
                      fontStyle: 'italic',
