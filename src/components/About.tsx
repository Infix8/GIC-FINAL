...
const About = () => {
    return (
        <section className="py-12 sm:py-16 md:py-20" id="about">
            <div className="max-w-full sm:max-w-[95%] md:max-w-[90%] lg:max-w-[85%] xl:max-w-[75%] mx-auto px-4 sm:px-6 md:px-8">
                {/* Section header */}
                <div className="mb-8 sm:mb-10 md:mb-12">
                    <h2 className="about-title text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-2" style={{ color: 'var(--color-text-primary)' }}>ABOUT THE CONCLAVE</h2>
                </div>
                ...
                <div className="about-content space-y-6 sm:space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                        <div
                            className="about-block p-4 sm:p-5 md:p-6 rounded-lg sm:rounded-xl card-hover-effect"
                            style={{
                                background: 'var(--color-bg-secondary)',
                                border: '1px solid rgba(255, 255, 255, 0.08)'
                            }}
                        >
                            <h3 className="text-base sm:text-lg font-bold mt-2" style={{ color: 'var(--color-text-primary)' }}>Vision</h3>
                        ...
                        >
                            <h3 className="text-base sm:text-lg font-bold mt-2" style={{ color: 'var(--color-text-primary)' }}>Objectives</h3>
                            <ul className="mt-2 space-y-1.5 sm:space-y-2 text-xs sm:text-sm list-disc pl-4" style={{ color: 'var(--color-text-secondary)' }}>
