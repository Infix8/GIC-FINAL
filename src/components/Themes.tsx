...
const Themes = () => {
    return (
        <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-12" id="themes">
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 sm:mb-10 md:mb-12 text-center">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mt-2" style={{ color: 'var(--color-text-primary)' }}>Key Themes</h2>
                </div>
